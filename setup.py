...
if os.environ.get('READTHEDOCS', False) == 'True':
    ...
    INSTALL_REQUIRES = ['dask', 'pyproj', 'netcdf4', 'toolz', 'wrf-python', 'tethys-utils==0.7.35', 'tethys-data-models==0.4.10', 'tethysts==0.4.27']
...
setup(
    ...
    url='https://github.com/mullenkamp/tethys-wrf',  # Optional
